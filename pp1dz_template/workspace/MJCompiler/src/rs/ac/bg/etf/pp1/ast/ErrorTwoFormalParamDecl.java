...
public class ErrorTwoFormalParamDecl extends FormalParamList {

    private FormalParamList FormalParamList;

    public ErrorTwoFormalParamDecl (FormalParamList FormalParamList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ErrorTwoFormalParamDecl(\n");
